  ...
  factory: function($config, $logger) {
    return {
      ...
      **/
      _init: function() {
        ...
        models.forEach(function(model) {
          let definition = require($config.basePath, "api/models", model);
          self._define(definition.name, definition.mapping, definition.options);
        });
      ...
      **/
       ...
       * defining table
      **/
      _define: function(name, mapping, options) {
