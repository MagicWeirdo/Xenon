...
class RequestHandler {
  ...
  **/
  registerModel(name, factory) {
    // all models are registered as singletons
    this._injector.put("singleton", name, factory);
  }
  ...
  **/
  registerService(scope, name, factory) {
    this._injector.put(scope, name, factory);
  }
